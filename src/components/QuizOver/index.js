...
const QuizOver = React.forwardRef((props, ref) => {
    ...
    const hash = "da024aa90a36c86133435a575117bf27";
    ...
    if(score < averageGrade){
        //Recommencez le quiz au début
        // setTimeout(() => loadLevelQuestions(0), 5000);

        //Recommencez le quiz au niveau actuel
        ...
        <Fragment>
            ...
            <div className="modalBody">
                <div className="comicImage">
                    ...
                    <small>{characterInfos.attributionText}</small>
                </div>
    ...
    return (
        <Fragment>
            ...
            <Modal showModal={isOpenModal} hideModal={hideModal}>
                { resultInModal }
            </Modal>
        </Fragment>
    )
